...
[MathJax](https://www.mathjax.org/#gettingstarted) is the javascript library Jupyter uses to render ![LaTeX](https://github.com/buruzaemon/IntroductionToProbabilityPy/blob/master/assets/LaTeX.gif). 
